...
function prepColors(input?: string[]) {
  ...
  for (let index = 0; index < base.length; index += 1) {
    avg[0] += colors[index][0];
    avg[1] += colors[index][1];
    avg[2] += colors[index][2];
  }
  ...
  return { colors, count: base.length, avg };
}
...
function Lightfall({
  ...
  useEffect(() => {
    ...
    const preparedColors = prepColors(colors);
    const uniforms = {
      iResolution: { value: [gl.drawingBufferWidth, gl.drawingBufferHeight, 1] },
      iMouse: { value: [0, 0] },
      iTime: { value: 0 },
      uColor0: { value: preparedColors.colors[0] },
      uColor1: { value: preparedColors.colors[1] },
      uColor2: { value: preparedColors.colors[2] },
      uColor3: { value: preparedColors.colors[3] },
      uColor4: { value: preparedColors.colors[4] },
      uColor5: { value: preparedColors.colors[5] },
      uColor6: { value: preparedColors.colors[6] },
      uColor7: { value: preparedColors.colors[7] },
      uColorCount: { value: preparedColors.count },
      uBgColor: { value: hexToRGB(backgroundColor) },
      uMouseColor: { value: preparedColors.avg },
      uSpeed: { value: speed },
      uStreakCount: {
