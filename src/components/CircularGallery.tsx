  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          vec2 ratio = vec2(
            min((uImageSizes.x / uImageSizes.y) / (uPlaneSizes.x / uPlaneSizes.y), 1.0),
            min((uImageSizes.y / uImageSizes.x) / (uPlaneSizes.y / uPlaneSizes.x), 1.0)
          );
          vec2 uv = vec2(
...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      { image: '/projects/lp-souzaclima.png', text: 'LP Souza Clima' },
      { image: '/projects/dashboard-financeiro.png', text: 'Dashboard Financeiro' },
      { image: '/projects/automacao-licitacao.png', text: 'Automação Licitação' },
    ];
