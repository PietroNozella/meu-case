...
class Media {
  ...
  update(scroll: { current: number; last: number }, direction: 'right' | 'left') {
    ...
    if (this.bend === 0) {
      ...
      const radius =
        (halfViewportWidth * halfViewportWidth + bend * bend) / (2 * bend);
...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      { image: '/projects/lp-souzaclima.png', text: 'LP SouzaClima' },
      { image: '/projects/dashboard-financeiro.png', text: 'Dashboard Financeiro' },
      { image: '/projects/automacao-licitacao.png', text: 'Automacao Licitacao' },
      { image: '/projects/project-2.jpg', text: 'Landing Page' },
      { image: '/projects/project-3.jpg', text: 'Dashboard' },
      { image: '/projects/project-4.jpg', text: 'App Web' },
      { image: '/projects/project-5.jpg', text: 'E-commerce' },
      { image: '/projects/project-6.jpg', text: 'Automação' },
    ];
...
export default function CircularGallery({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Galeria circular de projetos. Use as setas para navegar."
    />
  );
}
